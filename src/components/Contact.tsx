  ...
  return (
    <section className="py-24 bg-surface" id="contact">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="bg-primary rounded-[3rem] p-8 md:p-16 lg:p-24 relative overflow-hidden">
          {/* Decorative shapes */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 relative z-10">
            ...
            >
              ...
              <div className="bg-white/10 border border-white/20 p-6 rounded-2xl backdrop-blur-sm max-w-max">
                <p className="text-2xl font-heading font-bold text-white">
                  Prime One Consulting
                </p>
                <p className="text-secondary font-medium">dealership detail operations, managed right.</p>
              </div>
            </motion.div>
            ...
            >
              <form onSubmit={handleSubmit} className="bg-white p-8 md:p-10 rounded-[2rem] shadow-2xl">
                <h3 className="text-2xl font-bold text-primary mb-8">Request an Evaluation</h3>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-5 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-secondary focus:ring-2 focus:ring-secondary/20 outline-none transition-all placeholder:text-gray-400"
                      placeholder="John Doe"
                    />
                  </div>
                  
                  <div>
                    <label htmlFor="dealership" className="block text-sm font-medium text-gray-700 mb-2">Dealership Name</label>
                    <input 
                      type="text" 
                      id="dealership"
                      required 
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full px-5 py-4 rounded-xl bg-gray-50 border border-gray-200 focus:border-secondary focus:ring-2 focus:ring-secondary/20 outline-none transition-all placeholder:text-gray-400 resize-none"
                  ...
                  <button 
                    ...
                    className="w-full bg-primary hover:bg-gray-800 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {status === 'idle' && (
